...
for date_idx in range(n):
    ...
    if len(portfolio)<max_pos and cash>50000 and signal_date is not None:
        ...
        for code in IND:
            ...
            score=base_score*PENALTY.get(gc_days, 0.2)*(1+vol_bonus+rev_bonus)
...
print("\n"+"="*70)
print(" V46 v62_v20_reversal_v1 (量比加分+超跌反弹 >8%:+8% >15%:+15%)")
print("="*70)
...
result={
    'label':'V46 v62_v20_reversal_v1 (量比加分+超跌反弹 >8%:+8% >15%:+15%)',
    'final_nav':final_nav,
...
with open('/workspace/backtest_v46_v62_v20_reversal_v1.json','w') as f:
    json.dump(result, f, ensure_ascii=False, indent=2, default=str)
print(f"\n已保存到 /workspace/backtest_v46_v62_v20_reversal_v1.json")

with open('/workspace/V46_v62_v20_reversal_v1_trades.csv','w', newline='') as f:
