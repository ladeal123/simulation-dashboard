...
print("\n"+"="*70)
print(" V46 v62_v20_final (量价配合:5日量比加分10%/20%/35%)")
print("="*70)
...
result={
    'label':'V46 v62_v20_final (量价配合:5日量比加分10%/20%/35%)',
    'final_nav':final_nav,
...
with open('/workspace/backtest_v46_v62_v20_final.json','w') as f:
    json.dump(result, f, ensure_ascii=False, indent=2, default=str)
print(f"\n已保存到 /workspace/backtest_v46_v62_v20_final.json")
